...
public class RunLoader {
    ...
    public static void main(String argv[]) throws BridgeDBException {   
        ...
        try {
            ...
            //URL url;
            if (argv.length == 0){
                //urlReader = new UrlReader("file:///C:/Dropbox/ims/dev/version1.4.alpha1/load.xml");
                urlReader = new UrlReader("http://openphacts.cs.man.ac.uk/ims/dev/version1.4.alpha1/load.xml");
           } else {
                //url = null;
